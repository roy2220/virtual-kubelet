...
import (
	...
	"github.com/roy2220/virtual-kubelet/internal/manager"
...
// github.com/roy2220/virtual-kubelet/errdefs package in order for the
...
func (pc *PodController) syncPodInProvider(ctx context.Context, pod *corev1.Pod, key string) (retErr error) {
	...
	// more context is here: https://github.com/roy2220/virtual-kubelet/pull/760
